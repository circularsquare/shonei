...
public class SelectionContext {
    public Tile tile;
    public List<Structure> structures = new List<Structure>();  // non-null structures from tile.structs[], in depth order
    public List<Blueprint> blueprints = new List<Blueprint>();  // non-null blueprints from tile.blueprints[], in depth order
