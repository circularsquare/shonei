...
- *Shape*: `pixelsPerUnit` (8), `noiseScale` (0.15), `noiseAspect` (horizontal feature stretch, default 2.0). (`textureSize` is auto-computed from viewport + band, not inspector-tunable.)
