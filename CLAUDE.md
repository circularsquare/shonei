...
You can reference `Assets/SPEC.md`. It covers architecture, systems, save/load flow, animal AI, and the trading system. Reading it first avoids redundant exploration and ensures decisions align with established patterns.
